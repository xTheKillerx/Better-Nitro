...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "authors": [{
                "name": "BLooDMooN",
                "discord_id": "742789304719245324",
                "github_username": "xTheKillerx"
            }],
            "version": "1.0.0",
            "description": "BetterNitro | BLooDMooN - Cr: Bahady",
            "github": "https://github.com/xTheKillerx",
            "github_raw": "https://github.com/xTheKillerx"
        },
        "main": "betternitro.plugin.js"
    };
                ...
                getSettingsPanel() {
                    return Settings.SettingPanel.build(_ => this.saveAndUpdate(), ...[
                        new Settings.SettingGroup("Features").append(...[
                            new Settings.Switch("High Quality Screen Sharing", "Enable or disable 1080p/source @ 60fps Screen Sharing ", this.settings.screenSharing, value => this.settings.screenSharing = value)
                        ]),
                        new Settings.SettingGroup("Emoji").append(
                            ...
                            new Settings.SettingGroup("Profile Photo").append(...[
                                ...
                                new Settings.Textbox("URL", "Profile Photo Link.", this.settings.pfpUrl,
                                    image => {
                                        try {
                                            new URL(image)
                                        } catch {
                                            return Toasts.error('Wrong Link!')
                                        }
